<div id="jssor_1" class='jssor_1'>
		...
		<div data-u="slides" class='slides'>
			<?php
				$slide1 = $this->model_app->view_where_ordering_limit('iklanatas',array('username'=>'slide'),'id_iklanatas','ASC',0,10);
				$no=1;
				foreach ($slide1->result_array() as $row) {
					...
					echo "<div>
							<img data-u='image' src='".base_url()."asset/foto_iklanatas/$foto_slide'/>
