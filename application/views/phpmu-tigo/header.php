...
echo "<div class='wrapper'>			
	<div class='header-logo'>";
		  ...
		  foreach ($logo->result_array() as $row) {
			echo "<a href='".base_url()."'><img style='height:50px' 
			src='".base_url()."asset/logo/$row[gambar]'/></a>";
		  }
	echo "
	</div>	
	...
	<div class='header-menu'>
		<div class='header-search'>
			...
			<input type='text' placeholder='Cari Produk Disini'' name='kata' class='search-input' required/>
		...
		<span class='city'>
          ...
          if ($this->session->id_konsumen != ''){
            ...
            echo "
            	  ...
            	  <a class='btn btn-xs btn-success' style='padding:1px 12px' href='".base_url()."members/profile'>Profil</a> 
            	  <a class='btn btn-xs btn-danger' style='padding:1px 12px' href='".base_url()."members/logout'>Keluar</a>";
			 ...
			 echo "
			 		<a href='".base_url()."produk/keranjang'> 
			 			<span class='glyphicon glyphicon glyphicon-shopping-cart' style='font-size:19px'></span></b> 
            	  	<span class='badge badgee'>".rupiah($isi_keranjang['jumlah'])."</span></a> &nbsp; ";
            echo "<a class='btn btn-xs btn-success' style='width: 85px;  border-radius: 30px;' href='".base_url()."auth/login'>Masuk</a> 
                  <a class='btn btn-xs btn-default' style='width: 85px;  border-radius: 30px; color:#000' href='".base_url()."auth/register'>Daftar</a>";
