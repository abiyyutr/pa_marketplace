...
<p class='sidebar-title block-title'>Daftar Semua UMKM</p>
  <?php 
    $attributes = array('class'=>'pull-right','role'=>'form','style'=>'width:100%;');
    echo form_open_multipart('produk/reseller',$attributes); 
    echo "<input type='search' name='cari_reseller' class='form-control' style='display:inline-block; width:96%;' placeholder='Cari nama UMKM terdekat disini...'>
