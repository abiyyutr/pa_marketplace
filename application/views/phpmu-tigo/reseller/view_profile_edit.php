           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";                
                  ...
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td><b>Password</b></td>       <td><input class='form-control' style='width:50%; display:inline-block' type='password' name='a'> <small style='color:red'><i>Kosongkan aja jika tidak ingin diubah.</i></small></td></tr>
                          ...
                          <tr><td><b>Kelurahan</b></td>  <td><input type='text' class='required form-control' name='i' value='$row[kelurahan]'></td></tr>
