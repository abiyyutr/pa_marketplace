...
if ($this->uri->segment(3)=='success'){
    ...
    echo "<div class='alert alert-danger'>Masukkan Bukti Transfer dan Nama Pengirim Terlebih dahulu!</div>
      <table class='table table-condensed'>
        <tbody>
          <input type='hidden' name='id' value='$rows[id_penjualan]'>
          <tr><th scope='row' width='120px'>No Pemesanan</th>       <td><input type='text' name='a' class='form-control' style='width:100%' value='$rows[kode_transaksi]' placeholder='TRX-0000000000' required>";
          if ($rows['kode_transaksi']!=''){
            ...
            <tr><th scope='row'>Tanggal Transfer</th>             <td><input type='date' class='datepicker form-control' style='width:40%' name='e' data-date-format='yyyy-mm-dd' value='".date('Y-m-d')."'></td></tr>
            
            <tr><th scope='row'>Bukti Transfer</th>               <td><input type='file' name='g'></td></tr>";
          }
        echo "</tbody>
      </table>
