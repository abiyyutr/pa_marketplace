  <p class='sidebar-title text-danger produk-title'> Login Pelanggan</p> 
            ...
            <div class="logincontainer">
                <form method="post" action="<?php echo base_url(); ?>auth/login" role="form" id='formku'>
                    <div class="form-group">
                        ...
                        <input type="text" name="a" class="required form-control" autofocus=""  minlength='5' onkeyup="nospaces(this)" required oninvalid="this.setCustomValidity('Masukkan Username')" oninput="setCustomValidity('')">
                    </div>

                    <div class="form-group">
                        <label for="inputPassword">Password</label>
                        <input type="password" name="b" class="form-control required" autocomplete="off" required oninvalid="this.setCustomValidity('Masukkan Password')" oninput="setCustomValidity('')">
                    </div>
                    ...
                    <center><a href='<?php echo base_url(); ?>reseller'>Login Pelaku UMKM</a><center>
                </form>
            </div>
