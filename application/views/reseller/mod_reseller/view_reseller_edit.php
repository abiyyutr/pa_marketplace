<title>Pelaku UMKM | Edit Profile</title>
<?php 
    echo "<div class='col-md-15'>
          ...
          echo "<div class='col-md-15'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Toko</th>                <td><input class='form-control' type='text' name='c' value='$rows[nama_reseller]'></td></tr>
                    ...
                    <tr><th scope='row'>Kecamatan</th>             <td><input class='form-control' type='text' name='k' value='$rows[kecamatan]'></td></tr>
                    <tr><th scope='row'>Alamat Toko</th>           <td><input class='form-control' type='text' name='e' value='$rows[alamat_lengkap]'></td></tr>
                    <tr><th scope='row'>No HP</th>                 <td><input class='form-control' type='textr' name='f' value='$rows[no_telpon]'></td></tr>
