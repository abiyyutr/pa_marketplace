...
<title>Pelaku UMKM | Tambah Data Produk</title>
<?php 
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Berat Barang</th>                      <td><input type='text' class='form-control' name='berat'></td></tr>
                    ...
                    <tr><th scope='row'>Stok</th>                 <td><input type='number' class='form-control' name='stok'></td></tr>
              ...
              <div class='box-footer'>
                    <button type='submit' name='submit' class='btn btn-info'>Tambah Produk</button>
