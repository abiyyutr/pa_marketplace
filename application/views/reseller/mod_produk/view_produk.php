<title>Pelaku UMKM | Data Produk</title>
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Produk anda</h3>
                  <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url(); ?>reseller/tambah_produk'>Tambahkan Produk</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped table-condensed">
                    <thead>
                      <tr>
                        ...
                        <th>Nama Produk</th>
                        <!-- <th>Harga Modal</th> <td>Rp ".rupiah($modal)."</td>-->
                    ...
                    foreach ($record as $row){
                      ...
                      if ($row['id_produk_perusahaan']=='0'){ $modal = $row['harga_beli'];  }else{ $modal = $row['harga_reseller']; }
                          echo "<tr><td>$no</td>
                              ...
                              <td>$row[satuan]</td>
                              <td>$row[berat]</td>
                              <td>Rp<span style='text-decoration:$line'>".rupiah($row['harga_beli'])."</span> $harga</td>
