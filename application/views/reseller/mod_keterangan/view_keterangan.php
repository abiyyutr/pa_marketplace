<title>Pelaku UMKM | Keterangan Toko</title>
<?php 

    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Keterangan Toko</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart($this->uri->segment(1).'/keterangan',$attributes); 
          echo "<div class='col-md-12'>
                  <div class='alert alert-warning'><b>PENTING!</b> - Informasi ini akan ditampilkan pada Keranjang Belanja Pelanggan yang order produk anda.</div>
