<title>Admin | Laporan Penjualan UMKM</title>  

            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Daftar Semua Penjualan UMKM</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    // $pembelian = $this->db->query("SELECT sum((b.jumlah*b.harga_jual)-b.diskon) as total FROM rb_penjualan a JOIN rb_penjualan_detail b ON a.id_penjualan=b.id_penjualan where a.status_penjual='admin' AND a.id_pembeli='$row[id_reseller]' AND a.proses='2'")->row_array();
                    ...
                    //                                             JOIN rb_penjualan c ON a.id_penjualan=c.id_penjualan where c.status_penjual='reseller' AND b.id_produk_perusahaan!='0' AND id_penjual='$row[id_reseller]' AND c.proses='2'")->row_array();
                    ...
                    JOIN rb_penjualan c ON a.id_penjualan=c.id_penjualan where c.status_penjual='reseller' AND id_penjual='$row[id_reseller]' AND c.proses='3'")->row_array();
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>".rupiah($penjualan['produk'])." Produk</td>
