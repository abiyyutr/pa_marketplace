    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Pelaku UMKM</h3>
                </div>
              <div class='box-body'>";
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>NIK</th>                          <td><input class='form-control' type='number' name='h'></td></tr>
                    <tr><th scope='row'>Nama Toko/UMKM</th>                <td><input class='form-control' type='text' name='c'></td></tr>
                    <tr><th scope='row'>Nama Pemilik</th>                 <td><input class='form-control' type='text' name='j'></td></tr>
                   ...
                   <tr><th scope='row'>Kelurahan</th>                     <td><input class='form-control' type='text' name='l'></td></tr>
                   <tr><th scope='row'>Kecamatan</th>                     <td><input class='form-control' type='text' name='m'></td></tr> 
                   <tr><th scope='row'>No HP</th>                        <td><input class='form-control' type='number' name='f'></td></tr>
                    <tr><th scope='row'>Email</th>                        <td><input class='form-control' type='email' name='g'></td></tr>
