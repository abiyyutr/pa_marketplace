                ...
                <div class='box-body'>
                  ...
                  <div class='panel-body'>
                    <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                      <li role='presentation' class='active'><a href='#profile' id='profile-tab' role='tab' data-toggle='tab' aria-controls='profile' aria-expanded='true'>Data Pelanggan </a></li>
                      ...
                      <div role='tabpanel' class='tab-pane fade active in' id='profile' aria-labelledby='profile-tab'>
                          <div class='col-md-6'>
                            ...
                            <tbody>
                              ...
                              <tr><th scope='row'>Kelurahan</th> <td><?php echo $rows['kelurahan']?></td></tr>
                            ...
                            <table id="example1" class='table table-hover table-condensed'>
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  if ($row['proses']=='0'){ $proses = '<i class="text-danger">Sedang dikemas dan dikirim</i>'; }elseif($row['proses']=='1'){ $proses = '<i class="text-success">Pesanan diterima dan dibayar</i>'; }else{ $proses = '<i class="text-info">Pesanan diterima</i>'; }
